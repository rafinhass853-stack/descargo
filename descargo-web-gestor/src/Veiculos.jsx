...
export default function Veiculos() {
  ...
  const desassociarMotorista = async (veiculoId) => {
    if (window.confirm("Remover motorista deste veículo?")) {
      try {
        await updateDoc(doc(db, "cadastro_veiculos", veiculoId), { 
          motorista_id: '', 
          motorista_nome: 'SEM MOTORISTA' 
        });
          ...
          <select 
            ...
            onChange={e => {
              ...
              setNovoVeiculo({
                ...
                motorista_nome: mot ? mot.nome : 'SEM MOTORISTA'
              });
            }}
          >
...
const styles = {
  ...
  btnFiltro: { padding: '6px 12px', borderRadius: '4px', border: '1px solid #333', cursor: 'pointer', fontSize: '10px', fontWeight: 'bold', whiteSpace: 'nowrap' },
